...
export default function Home() {
  return (
    <main className="flex items-center overflow-hidden flex-col">
      <Navbar />
      <section className="h-full w-full overflow-hidden bg-neutral-950 rounded-md relative flex flex-col items-center  antialiased">
        <div className="absolute inset-0  h-full w-full items-center px-5 py-10 [background:radial-gradient(125%_125%_at_50%_10%,#000_35%,#223_100%)]"></div>
            ...
            titleComponent={
              <div className="flex items-center flex-col">
                ...
                <h1 className="text-5xl md:text-8xl  bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-bold">
                  Automate Your Work With Napier
                </h1>
              </div>
            }
          />
        ...
        <InfiniteMovingCards
          className="md:mt-[1rem] mt-[-50px] pb-10"
          items={clients}
          direction="right"
          speed="slow"
        />
      ...
      <section className="w-full flex flex-col items-center justify-center">
        <LampComponent />
        <div className="flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-72 pb-20 px-4">
