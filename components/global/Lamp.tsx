  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-20 bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 px-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Plans That
        <br /> Fit You Best
      </motion.h1>
